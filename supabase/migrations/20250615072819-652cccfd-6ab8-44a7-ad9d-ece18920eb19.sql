...
-- Função para salvar produtos vendidos automaticamente
...
BEGIN
  ...
  -- Limpar produtos vendidos anteriores para este período
...
ALTER TABLE public.relatorios_vendas 
ADD CONSTRAINT uk_relatorios_vendas_data_periodo 
UNIQUE (data_relatorio, periodo);
